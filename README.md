...
Projeto de Análise Exploratória de Dados (EDA) desenvolvido em dupla utilizando Python, focado no catálogo de filmes e programas de TV da Netflix disponibilizado no Kaggle. O objetivo foi aplicar técnicas práticas de higienização de dados e extrair insights sobre a distribuição de conteúdo da plataforma.
